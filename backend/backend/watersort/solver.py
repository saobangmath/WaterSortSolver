...
if __name__ ==  "__main__":
    game = GameState()
    game.add_bottle(Bottle(4, ["XanhLaNhat", "XanhBlueNhat", "XanhLa", "Xam"]))
    game.add_bottle(Bottle(4, ["Tim", "XanhLa", "Hong", "Do"]))
    game.add_bottle(Bottle(4, ["XanhBlue", "Xam", "Nau", "XanhCyan"]))
    game.add_bottle(Bottle(4, ["Nau", "XanhBlueNhat", "XanhLaNhat", "XanhBlueNhat"]))
    game.add_bottle(Bottle(4, ["Cam", "Cam", "Cam", "Xam"]))
    game.add_bottle(Bottle(4, ["Nau", "Nau", "XanhLaNhat", "Do"]))
    game.add_bottle(Bottle(4, ["XanhCyan", "Do", "Vang", "XanhBlue"]))

    game.add_bottle(Bottle(4, ["Xam", "Cam", "Vang", "Do"]))
    game.add_bottle(Bottle(4, ["XanhLa", "XanhCyan", "Vang", "Tim"]))
    game.add_bottle(Bottle(4, ["XanhBlue", "Vang", "XanhBlueNhat", "Tim"]))
    game.add_bottle(Bottle(4, ["Hong", "XanhCyan", "XanhBlue", "XanhLaNhat"]))
    game.add_bottle(Bottle(4, ["Tim", "XanhLa", "Hong", "Hong"]))
